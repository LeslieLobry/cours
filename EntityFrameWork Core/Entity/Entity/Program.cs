...
//context.Livres.Update(nouveauLivreRemplacement); // mets à jour TOUT les champs
//context.SaveChanges();
...
//context.Attach(nouveauLivreRemplacement2); // on le lie à la BDD, l'objet devient traqué
