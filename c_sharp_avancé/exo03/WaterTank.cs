...
namespace exo03
{
    ...
    internal class WaterTank
    {
        ...
        // Propriété calculée pour le poids total
        public int TotalWeight => FillLevel + WeightEmpty; 
        public static int TotalFillLevels  ;
        ...
        public WaterTank(int fillLevel, int maxCapacity, int weightEmpty)
        {
            ...
            FillLevel = fillLevel; // Doit être défini après MaxCapacity pour validation
